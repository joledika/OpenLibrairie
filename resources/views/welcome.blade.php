...
<body>
    ...
    <div class="container">
      ...
      <div class="navigation collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav">
          <li class="current"><a href="#intro">Acceuil</a></li>
    ...
    <div class="container">
      ...
      <div class="row wow fadeInUp">
        <div class="col-md-6 about-img">
          <img src="{{asset('home_page/img/about-img.jpg')}}" alt="">
        </div>
            ...
            <div class="carousel-inner">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12 col-md-5">
                    <div class="screenshot wow bounceInRight">
                      <img src="{{asset('home_page/img/screenshots/1.png')}}" class="img-responsive" alt="" />
                    </div>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="row">
                  ...
                  <div class="col-sm-12 col-md-5">
                    <div class="screenshot wow bounceInRight">
                      <img src="{{asset('home_page/img/screenshots/2.png')}}" class="img-responsive" alt="" />
                    </div>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="row">
                  ...
                  <div class="col-sm-12 col-md-5">
                    <div class="screenshot wow bounceInRight">
                      <img src="{{asset('home_page/img/screenshots/3.png')}}" class="img-responsive" alt="" />
                    </div>
                  </div>
                </div>
              </div>
  ...
  <section id="parallax2" class="home-section parallax" data-stellar-background-ratio="0.5">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <ul class="clients">
            <li class="wow fadeInDown" data-wow-delay="0.3s"><a href="#"><img src="{{asset('home_page/img/clients/1.png')}}" alt="" /></a></li>
            <li class="wow fadeInDown" data-wow-delay="0.6s"><a href="#"><img src="{{asset('home_page/img/clients/2.png')}}" alt="" /></a></li>
            <li class="wow fadeInDown" data-wow-delay="0.9s"><a href="#"><img src="{{asset('home_page/img/clients/3.png')}}" alt="" /></a></li>
            <li class="wow fadeInDown" data-wow-delay="1.1s"><a href="#"><img src="{{asset('home_page/img/clients/4.png')}}" alt="" /></a></li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
          <div class="box-team wow bounceInUp" data-wow-delay="0.1s">
            <img src="{{asset('home_page/img/team/1.jpg')}}" alt="" class="img-circle img-responsive" />
          ...
          <form action="" method="post" class="form-horizontal contactForm" role="form">
            <div class="col-md-offset-2 col-md-8">
              <div class="form-group">
                <input type="text" name="name" class="form-control" id="name" placeholder="Ton nom" data-rule="minlen:4"
            ...
            <div class="col-md-offset-2 col-md-8">
              <div class="form-group">
                <input type="email" class="form-control" name="email" id="email" placeholder="Ton Email" data-rule="email"
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="contact-widget wow bounceInRight">
            ...
            <h5>Nos emails</h5>
            <p>
              jodii@gmail.com.com<br />sales@alstarstudio.com
            </p>
          </div>
        </div>
      </div>
  ...
  <!-- js -->
  <script src="{{asset('home_page/js/jquery.js')}}"></script>
  <script src="{{asset('home_page/js/bootstrap.min.js')}}"></script>
  <script src="{{asset('home_page/js/wow.min.js')}}"></script>
  <script src="{{asset('home_page/js/jquery.scrollTo.min.js')}}"></script>
  <script src="{{asset('home_page/js/jquery.nav.js')}}"></script>
  <script src="{{asset('home_page/js/modernizr.custom.js')}}"></script>
  <script src="{{asset('home_page/js/grid.js')}}"></script>
  <script src="{{asset('home_page/js/stellar.js')}}"></script>
  <!-- Contact Form JavaScript File -->
  <script src="{{asset('home_page/js/contactform.js')}}"></script>
