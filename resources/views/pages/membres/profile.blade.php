            ...
            <div class="row">
                <div class="col-12">
                    <div class="site-branding flex flex-column align-items-center">
                        <h1 class="site-title"><a href="index.html" rel="home">test</a></h1>
                        <p class="site-description">Profil personnel</p>
                    </div><!-- .site-branding -->
                    ...
                    <nav class="site-navigation">
                        ...
                        <ul class="flex-lg flex-lg-row justify-content-lg-center align-content-lg-center">
                            <li class="current-menu-item"><a href="{{route('home_path')}}">Accueil</a></li>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="hero-content flex justify-content-center align-items-center flex-column">
                                <img src="{{asset('profile/images/slider.jpg')}}" alt="">
                            </div><!-- .hero-content -->
                        </div><!-- .swiper-slide -->
                ...
                <div class="offset-lg-9 col-12 col-lg-3">
                    <a href="#">
                        <div class="yt-subscribe">
                            {{--  PHOTO DE PROFIL  --}}
                            <img src="{{asset('profile/images/yt-subscribe.png')}}" alt="Youtube Subscribe">
                            {{--  FIRSTNAME  --}}
                            <h3>Firstname</h3>
                            {{--  LASTNAME  --}}
                            <p>LastName</p>
        ...
        <div class="row">
            <div class="col-12 col-lg-9">
                <div class="content-wrap">
                    <header class="entry-header">
                        <div class="posted-date">
                            January 30, 2018 (date de dernier livre uploade)
                        </div><!-- .posted-date -->

                        <h2 class="entry-title">Titre de son dernier livre</h2>
                    ...
                    <figure class="featured-image">
                        {{--  PHOTO A LA UNE  --}}
                        <img src="{{asset('profile/images/1.jpg')}}" alt="">
                ...
                <div class="content-wrap">
                    ...
                    <figure class="featured-image">
                        <img src="{{asset('profile/images/2.jpg')}}" alt="">
                    </figure><!-- .featured-image -->
                ...
                <div class="content-wrap">
                    ...
                    <figure class="featured-image">
                        <img src="{{asset('profile/images/3.jpg')}}" alt="">
                    </figure><!-- .featured-image -->
            ...
            <div class="col-12 col-lg-3">
                <div class="sidebar">
                    ...
                    {{--  RECENT LIVRE TELECHARGER  --}}
                    <div class="recent-posts">
                        <div class="recent-post-wrap">
                            <figure>
                                <img src="{{asset('profile/images/thumb-1.jpg')}}" alt="">
                            </figure>
                        ...
                        <div class="recent-post-wrap">
                            <figure>
                                <img src="{{asset('profile/images/thumb-2.jpg')}}" alt="">
                            </figure>
                        ...
                        <div class="recent-post-wrap">
                            <figure>
                                <img src="{{asset('profile/images/thumb-3.jpg')}}" alt="">
                            </figure>
                        ...
                        <div class="recent-post-wrap">
                            <figure>
                                <img src="{{asset('profile/images/thumb-4.jpg')}}" alt="">
                            </figure>
                    ...
                    {{--  FIN  RECENT LIVRE TELECHARGER --}}
                    <div class="sidebar-ads">
                        <img src="{{asset('profile/images/ads.jpg')}}" alt="ads">
                    </div>
                </div><!-- .sidebar -->
            </div><!-- .col -->
        </div><!-- .row -->
            ...
            <div class="row footer-recent-posts">
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="footer-post-wrap flex justify-content-between">
                        <figure>
                            <a href="#"><img src="{{asset('profile/images/foot-1.jpg')}}" alt=""></a>
                        </figure>
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="footer-post-wrap flex justify-content-between">
                        <figure>
                            <a href="#"><img src="{{asset('profile/images/foot-2.jpg')}}" alt=""></a>
                        </figure>
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="footer-post-wrap flex justify-content-between">
                        <figure>
                            <a href="#"><img src="{{asset('profile/images/foot-3.jpg')}}" alt=""></a>
                        </figure>
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="footer-post-wrap flex justify-content-between">
                        <figure>
                            <a href="#"><img src="{{asset('profile/images/foot-4.jpg')}}" alt=""></a>
                        </figure>
    ...
    {{--  <div class="container-fluid">
        <div class="row">
            <div class="footer-instagram flex flex-wrap flex-lg-nowrap">
                <figure>
                    <a href="#"><img src="{{asset('profile/images/a.jpg')}}" alt=""></a>
                </figure>

                <figure>
                    <a href="#"><img src="{{asset('profile/images/b.jpg')}}" alt=""></a>
                </figure>

                <figure>
                    <a href="#"><img src="{{asset('profile/images/c.jpg')}}" alt=""></a>
                </figure>

                <figure>
                        <a href="#"><img src="{{asset('profile/images/d.jpg')}}" alt=""></a>
                </figure>

                <figure>
                    <a href="#"><img src="{{asset('profile/images/e.jpg')}}" alt=""></a>
                </figure>

                <figure>
                    <a href="#"><img src="{{asset('profile/images/f.jpg')}}" alt=""></a>
                </figure>

                <figure>
                    <a href="#"><img src="{{asset('profile/images/g.jpg')}}" alt=""></a>
                </figure>
            </div>
        </div><!-- .row -->
    </div><!-- .container -->  --}}
                ...
                <div class="row justify-content-between">
                    <div class="col-12 col-md-6">
                        <div class="footer-copyright">
                            ...
                            <p>Copyright &copy;<script>document.write(new Date().getFullYear());</script> tous droit résérvé </p>
