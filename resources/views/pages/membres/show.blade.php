...
<head>
	...
	<!-- Favicon-->
	<link rel="shortcut icon" href="{{asset('profile/img/fav.png')}}">
	<!-- Author Meta -->
	...
	{{--  <link href="{{asset('profile/https://fonts.googleapis.com/css?family=Poppins:100,200,400,300,500,600,700" rel="stylesheet">
	<link href="{{asset('profile/https://fonts.googleapis.com/css?family=Roboto:300,400,500,600,700,900" rel="stylesheet">  --}}
	<!--
			CSS
			============================================= -->
	<link rel="stylesheet" href="{{asset('profile/css/linearicons.css')}}">
	...
	<link rel="stylesheet" href="{{asset('profile/css/nice-select.css')}}">
	<link rel="stylesheet" href="{{asset('profile/css/animate.min.css')}}">
		...
		<div class="container">
			<div class="row fullscreen d-flex align-items-center">
				<div class="banner-content col-lg-6 col-md-12 justify-content-center ">
					<div class="me wow fadeInDown" data-wow-duration="1s" data-wow-delay="1.2s">Je suis</div>
					<h1 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="1.7s">{{$user->name}}</h1>
                    ...
                    <a href="{{route('members_path')}}" class="primary-btn" data-text="Les membres">
						<span>A</span>
						<span>c</span>
						<span>c</span>
						<span>u</span>
			...
			<div class="brand-wrap">
				<div class="row align-items-center active-brand-carusel justify-content-start no-gutters">
					<div class="col single-brand">
						<a href="/#"><img class="mx-auto" src="{{asset('profile/img/brand/b1.png')}}" alt=""></a>
					</div>
					<div class="col single-brand">
						<a href="/#"><img class="mx-auto" src="{{asset('profile/img/brand/b2.png')}}" alt=""></a>
					</div>
					<div class="col single-brand">
						<a href="/#"><img class="mx-auto" src="{{asset('profile/img/brand/b3.png')}}" alt=""></a>
					</div>
					<div class="col single-brand">
						<a href="/#"><img class="mx-auto" src="{{asset('profile/img/brand/b4.png')}}" alt=""></a>
					</div>
					<div class="col single-brand">
						<a href="/#"><img class="mx-auto" src="{{asset('profile/img/brand/b5.png')}}" alt=""></a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row align-items-center justify-content-between">
				<div class="col-lg-6 about-left">
					<img class="img-fluid" src="{{asset('profile/img/myAvatar.png')}}" alt="">
				</div>
				...
				<div class="row grid">
					<div class="single-work col-lg-4 col-md-6 col-sm-12 all creative wow fadeInUp" data-wow-duration="2s">
						<div class="relative">
							<div class="thumb">
								...
								<img class="image img-fluid" src="{{asset('profile/img/work/w1.jpg')}}" alt="">
							</div>
							<div class="middle">
					...
					<div class="single-work col-lg-4 col-md-6 col-sm-12 all web-design branding wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
						<div class="relative">
							<div class="thumb">
								<div class="overlay overlay-bg"></div>
								<img class="image img-fluid" src="{{asset('profile/img/work/w2.jpg')}}" alt="">
							</div>
							<div class="middle">
								<h4>2D Vinyl Design</h4>
								<div class="cat">Client Project</div>
					...
					<div class="single-work col-lg-4 col-md-6 col-sm-12 all branding web-design wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.4s">
						<div class="relative">
							<div class="thumb">
								<div class="overlay overlay-bg"></div>
								<img class="image img-fluid" src="{{asset('profile/img/work/w3.jpg')}}" alt="">
							</div>
							<div class="middle">
								<h4>2D Vinyl Design</h4>
								<div class="cat">Client Project</div>
					...
					<div class="single-work col-lg-4 col-md-6 col-sm-12 all web-design wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.6s">
						<div class="relative">
							<div class="thumb">
								<div class="overlay overlay-bg"></div>
								<img class="image img-fluid" src="{{asset('profile/img/work/w6.jpg')}}" alt="">
							</div>
							<div class="middle">
								<h4>2D Vinyl Design</h4>
								<div class="cat">Client Project</div>
					...
					<div class="single-work col-lg-4 col-md-6 col-sm-12 all creative wow fadeInUp" data-wow-duration="2s">
						<div class="relative">
							<div class="thumb">
								<div class="overlay overlay-bg"></div>
								<img class="image img-fluid" src="{{asset('profile/img/work/w4.jpg')}}" alt="">
							</div>
							<div class="middle">
								<h4>2D Vinyl Design</h4>
								<div class="cat">Client Project</div>
					...
					<div class="single-work col-lg-4 col-md-6 col-sm-12 all branding wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
						<div class="relative">
							<div class="thumb">
								<div class="overlay overlay-bg"></div>
								<img class="image img-fluid" src="{{asset('profile/img/work/w5.jpg')}}" alt="">
							</div>
							<div class="middle">
								<h4>2D Vinyl Design</h4>
								<div class="cat">Client Project</div>
							</div>
							<a class="overlay" href="profile/portfolio-details.html"></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="testi_slider owl-carousel">
				<div class="item">
					<div class="testi_item">
						<img src="{{asset('profile/img/quote.png')}}" alt="">
						<h4>Fanny Spencer</h4>
						<ul class="list">
			...
			<div class="row mt-80">
                ...
                {{--  <div class="row">
                    <div class="col-lg-12 text-center">
                        <a href="/#" class="primary-btn mt-50" data-text="Contacter Moi">
                            <span>C</span>
                            <span>o</span>
                            <span>n</span>
                            <span>t</span>
				...
				<div class="col-lg-12">
					<div class="footer-top flex-column">
						<div class="footer-logo">
							<a href="/#">
								<img src="{{asset('profile/img/logo.png')}}" alt="">
							</a>
							<h4>Follow Me</h4>
						</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
	...
	<div id="back-top">
		<a title="Go to Top" href="profile/#">
			<i class="lnr lnr-arrow-up"></i>
		</a>
	</div>
	<!-- ####################### End Scroll to Top Area ####################### -->

	<script src="{{asset('profile/js/vendor/jquery-2.2.4.min.js')}}"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q"
	 crossorigin="anonymous"></script>
	<script src="{{asset('profile/js/vendor/bootstrap.min.js')}}"></script>
	<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>
	<script src="{{asset('profile/js/easing.min.js')}}"></script>
	<script src="{{asset('profile/js/hoverIntent.js')}}"></script>
	<script src="{{asset('profile/js/superfish.min.js')}}"></script>
	<script src="{{asset('profile/js/mn-accordion.js')}}"></script>
	...
	<script src="{{asset('profile/js/jquery.nice-select.min.js')}}"></script>
	<script src="{{asset('profile/js/isotope.pkgd.min.js')}}"></script>
	<script src="{{asset('profile/js/jquery.circlechart.js')}}"></script>
